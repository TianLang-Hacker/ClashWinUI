...
{
    public sealed class BooleanToCardBackgroundBrushConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            bool isCurrent = value is bool selected && selected;
            return ResolveBrush(
                isCurrent ? "AccentFillColorSecondaryBrush" : "CardBackgroundFillColorSecondaryBrush",
                isCurrent ? Colors.SteelBlue : Colors.Transparent);
        }
